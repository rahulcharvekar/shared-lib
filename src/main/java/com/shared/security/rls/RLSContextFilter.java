 ...
 * 
 * This filter runs after Spring Security authentication and extracts the
 * authenticated user's ID
 * to set in the RLS context. This ensures all database queries in the request
 * are properly
...
public class RLSContextFilter extends OncePerRequestFilter {
    ...
    private String extractUserId(Object principal) {
        ...
        // PRIORITY 2: Try reflection to get getId() method (works with User entities
        // that have getId())
        try {
